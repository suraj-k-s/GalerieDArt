                                            ...
                                            <div class="quick_activity_wrap">
                                                <div class="single_quick_activity d-flex">
                                                    ...
                                                    <div class="count_content">
                                                        ...
                                                        <?php
														$sel = "select count(shop_id) as id from tbl_shop where shop_vstatus=1";
                                                ...
                                                <div class="single_quick_activity d-flex">
                                                    ...
                                                    <div class="count_content">
                                                        <h3><span class="counter">
                                                        <?php
														$sel = "select count(artist_id) as id from tbl_artist where artist_vstatus=1";
														$result = $Conn->query($sel);
														$data = $result->fetch_assoc();
														echo $data["id"];
                                                        ?>
                                         ...
                                         <!--   <div class="quick_activity_wrap">
                                                <div class="single_quick_activity d-flex">
                                                    ...
                                                    <div class="count_content">
                                                        <h3><span class="counter">
                                                        <?php
														//$sel = "select count(artist_id) as id from tbl_artist";
														//$result = $Conn->query($sel);
														//$data = $result->fetch_assoc();
														//echo $data["id"];
                                                        ?>
                        ...
                        <div class="col-xl-12">
                            <div class="white_box card_height_100">
                                ...
                                <div class="staf_list_wrapper sraf_active owl-carousel">
                                    <?php
                                        $selQry = "select * from tbl_shop where shop_vstatus=1";
                                    ...
                                    <div class="single_staf">
                                        <div class="staf_thumb">
                                            <img src="../Assets/Files/Photos/<?php echo $data1["shop_photo"] ?>" alt="">
                                        </div>
                            ...
                            <div class="white_box card_height_100">
                                <div class="box_header border_bottom_1px  ">
                                    <div class="main-title">
                                        <h3 class="mb_25">Artist</h3>
                                    </div>
                                </div>
                                <div class="staf_list_wrapper sraf_active owl-carousel">
                                    <?php
                                        $selQry = "select * from tbl_artist where artist_vstatus=1";
                                        $result1 = $Conn->query($selQry);
										while($data1 = $result1->fetch_assoc())
                                        {
                                    ?>
                                    <div class="single_staf">
                                        <div class="staf_thumb">
                                            <img src="../Assets/Files/Photos/<?php echo $data1["artist_photo"] ?>" alt="">
                                        </div>
                                        <h4><?php echo $data1["artist_name"] ?></h4>
                                        <p><?php echo $data1["artist_contact"] ?></p>
                                    </div>
                                    <?php
                                        }
                                    ?>
