...
$dname = "";
	...
	if(isset($_POST['btn_save']))
	{
		...
		if(isset($_GET['eid']))
        {
     		...
     		$up="update tbl_district set district_name='".$district."' where district_id='".$_GET['eid']."'";
                                        ...
                                        <div class="white_box mb_30">
                                            ...
                                            <form method="post">
                                                <div class="form-group">
                                                    ...
                                                    <input required="" type="text" class="form-control" id="txt_district" name="txt_district" autocomplete="off" required value="<?php echo $dname;?>">
                                    ...
                                    <table class="table lms_table_active">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="District.php?eid=<?php echo $data["district_id"];?>&ename=<?php echo $data["district_name"];?>" class="status_btn">Edit</a></td>                                       
                                                </tr>
                                            <?php                    
                                              }
