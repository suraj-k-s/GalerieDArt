    ...
    <body class="crm_body_bg">
        ...
        <nav class="sidebar">
            <div class="logo d-flex justify-content-between">
                <a href="HomePage.php"><h2 align="center">Welcome<br>Admin<br><?php echo $_SESSION["adname"]?></h2></a>
            ...
            <ul id="sidebar_menu">
                ...
                <li class="">
                   ...
                   <li>
                        ...
                        <li><a href="Complainttype.php">Complaint Type</a></li>
                ...
                <li class="">
                   ...
                   <li class="">
                        <a   class="has-arrow" href="ArtistList.php" aria-expanded="false">
                            <img src="../Assets/Template/Admin/img/menu-icon/2.svg" alt="">
                            <span>Artist</span>
                        </a>	
                   </li>
                <li class="">
                   ...
                   <ul>
                   <li>
                    	<li><a href="ArtistReport.php">Artist</a></li>
                        <li><a href="ShopReport.php">Shop</a></li>
                        <li><a href="Report.php">Product</a></li>
                        <li><a href="ArtReport.php">Art</a></li>
                    </ul>
                </li>
