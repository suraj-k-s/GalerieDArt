...
include('Head.php');
    ...
    if(isset($_POST["btn_save"])) {
            ...
            $upQry = "update tbl_complaint set complaint_replay='".$_POST["txt_reply"]."',complaint_status='1' where complaint_id='".$_POST["hid"]."'";
            $Conn->query($upQry);
                                    ...
                                    <table class="table lms_table_active">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center"><?php echo $data["complaint_date"] ?></td>
                                                <td align="center"><?php echo $data["user_name"] ?></td>
                                                <td align="center"><?php echo $data["complaint_replay"] ?></td>
                                            </tr>
                                            <?php                     }
