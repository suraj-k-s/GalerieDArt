			...
			<?php
				include('../Assets/Connection/Connection.php');
				 ...
				 $l=0;
			 	 ...
			 	 $selQry = "select * from tbl_artist where true";
				
				 
				 if(isset($_POST["btn_search"]))
						{
							$selQry = $selQry." and artist_doj between '".$_POST["fdate"]."' and '".$_POST["tdate"]."'";
						}
                   ...
                   while ($data = $rs->fetch_assoc()) 
				   {
					   ...
					   if($data["artist_vstatus"]==0)
					   {
						   $j++;
					   }
					   if($data["artist_vstatus"]==1)
					   {
						   $k++;
					   }
					   if($data["artist_vstatus"]==2)
					   {
						   $l++;
					   }
