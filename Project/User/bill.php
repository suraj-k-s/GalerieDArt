...
$selqry="select * from tbl_artbooking b inner join tbl_art a on a.art_id=b.art_id inner join tbl_genere g on g.genere_id=a.genere_id inner join tbl_artist c on c.artist_id=a.artist_id inner join tbl_user u on u.user_id=b.user_id where artbooking_id='".$_GET["id"]."'";
        ...
        <table style="width: 100%; table-layout: fixed">
          <tr>
            ...
            >
              ...
              >
              	<span
                style="color:#F93;font-size:56px">Galery DArt</span>
      ...
      >
        <thead style="display: table-header-group">
          ...
          <tr>
            ...
            <th style="width: 150px">Art</th>
            <th style="width: 100px">Genere
            </th>
        ...
        <tbody>
          <tr>
            <td>01</td>
            <td><?php echo $data["art_title"] ?></td>
            <td><?php echo $data["genere_name"] ?></td>
            <td><img src="../Assets/Files/ArtPhoto/<?php echo $data["art_photo"];?>" width="119" height="92" /></td>
            <td><?php echo $data["art_price"] - ($data["art_price"] * (5/100)) ?></td>
            <td><?php echo $data["art_price"] * (5/100) ?></td>
            <td><?php echo $data["art_price"] ?></td>
          </tr>
        </tbody>
        <tfoot></tfoot>
      </table>
