...
$selqry="select * from tbl_booking b inner join tbl_cart c on c.booking_id=b.booking_id inner join tbl_product p on p.product_id=c.product_id inner join tbl_shop s on s.shop_id=p.shop_id inner join tbl_subcategory e on e.subcategory_id=p.subcategory_id inner join tbl_category t on t.category_id=e.category_id inner join tbl_user u on u.user_id=b.user_id where c.booking_id='".$_GET["id"]."'";
        ...
        <table style="width: 100%; table-layout: fixed">
          <tr>
            ...
            >
              ...
              >
              	<span
                style="color:#F93;font-size:56px">Galerie DArt</span>
      ...
      >
        ...
        <tbody>
          <tr>
            ...
            <td><img src="../Assets/Files/ProductPhotos/<?php echo $data["product_photo"];?>" width="119" height="92" /></td>
            <td><?php echo $data["product_price"] - ($data["product_price"] * (5/100)	) ?></td>
            <td><?php echo $data["product_price"] * (5/100) ?></td>
      ...
      <table class="hm-p table-bordered" style="width: 100%; margin-top: 30px">
        ...
        <tr style="background: #fcbd02">
          ...
          <td style="width: 70px; text-align: right; border-right: none">
            <b><?php echo $data["product_price"] ?></b>
          </td>
