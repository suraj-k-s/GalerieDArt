        ...
        <div class="shopping-cart" style="margin-top: 50px">            <?php                
                ...
                while ($row=$res->fetch_assoc()) {
                    ...
                    if ($rowpr=$respr->fetch_assoc()) {
                        $selstock = "select sum(stock_qty) as stock from tbl_stock where product_id='".$rowpr["product_id"]."'";
						 $selStock1= "select sum(cart_qty) as qty from tbl_cart where product_id='".$rowpr["product_id"]."' and cart_status >'0'";
            ...
            <div class="product">
                <div class="product-image">
                    <img
                        src="../Assets/Files/ProductPhotos/<?php echo $rowpr["product_photo"] ?>"
                        />
                </div>
                ...
                <div class="product-quantity">
                    <input alt="<?php echo $row["cart_id"] ?>" type="number" value="<?php echo $row["cart_qty"]?>" min="1" max="<?php echo $rowst["stock"]-$chk["qty"] ?>"/>
                </div>
