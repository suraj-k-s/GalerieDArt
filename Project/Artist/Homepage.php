                            ...
                            <div class="collapse navbar-collapse" id="studioMenu">
                                ...
                                <ul class="navbar-nav ml-auto">
                                    ...
                                    <li class="nav-item dropdown">
                                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Art Details</a>
                                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            <a class="dropdown-item" href="Art.php">Add Art</a>
                                            <a class="dropdown-item" href="ArtOrderDetails.php">Order Details</a>
                                            <a class="dropdown-item" href="ViewArtComplaints.php">Complaints</a>
                                        </div>
                                    </li>
                                    <li class="nav-item dropdown">
                                    ...
                                    <li class="nav-item dropdown">
                                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Exhibition</a>
                                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            <a class="dropdown-item" href="Exhibition.php">Exhibition</a>
                                            <a class="dropdown-item" href="ExhibitionBookingDetails.php">Exhibition Bookings</a>
                                        </div>
                                    </li>
                                    <li class="nav-item active">
